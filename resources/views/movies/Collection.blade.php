...
@foreach($movies as $movie)
    <div class="col-lg-12 d-flex justify-content-center">
        <h1 class="mt-4 mb-5"
            ...
            watch {{$movie->name}} movies on Roya Watch
        </h1>
    </div>
    ...
    <div class="container mt-3">
        ...
        <div class="row mb-5"
            ...
            <div class="col-lg-12 d-flex justify-content-center">
                @foreach($category_type as $types)
                    <h3 class="mr-3 mt-3"><span class="badge badge-dark">
                        <a href="{{route('movies.collection',['name'=>$types->name])}}">
                            {{$types->name}}
            ...
            @if($movie->Movies->count() >= 1)

            @foreach($movie->Movies as $type)
                    ...
                    @foreach($posts->where('id',$type->post_id) as $post)
                        <div class="col-lg-4 mt-5 mb-5 ">
                            <a href="{{route('movies.show',['id'=>$type->id])}}" style="text-decoration: none;">
